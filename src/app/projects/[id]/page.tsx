...
const projects = [
...

  {
    id: "project5",
    title: "ThinkShare",
    description: "Thinkshare est une plateforme sociale académique innovante...",
    fullDescription: `
      ...
      - Infrastructure : Azure Cloud, Kubernetes (K8s), Terraform (IaC), Docker, GitHub Actions
      - Monitoring & Big Data : Grafana, Prometheus, Azure Monitor
    ...
    `,
    image: "/thinkshare.png",
    gallery: [
      "/thinkshare.png?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
    ],
    tags: [
    ...
    challenges: "Défis techniques : orchestrer le backend sur Kubernetes, gérer la scalabilité et la sécurité des données utilisateurs.",
    learnings: "Maîtrise de Flutter pour le web et le mobile, déploiement cloud avancé, CI/CD avec GitHub Actions, monitoring avec Grafana et Prometheus.",
    featured: true,
  },
]
